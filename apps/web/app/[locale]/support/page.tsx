...
const faqs = [
  ...
  },
  {
    ...
    questionZh: '如何获得技术支持？',
    answerEn: 'You can reach our technical support team via email at support@ccscale.com or by phone during business hours. We typically respond within 24 hours.',
    answerZh: '您可以通过电子邮件support@ccscale.com或在工作时间致电联系我们的技术支持团队。我们通常在24小时内回复。',
  },
  {
  ...
  return (
    <div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="text-center border-none">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Phone className="h-8 w-8 text-[#0A1628]" />
                </div>
                <h3 className="font-semibold text-xl mb-2 text-[#0A1628]">
            ...
            <Card className="text-center border-none">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Mail className="h-8 w-8 text-[#0A1628]" />
                </div>
                <h3 className="font-semibold text-xl mb-2 text-[#0A1628]">
                  {locale === 'en' ? 'Email Us' : '发送邮件'}
                </h3>
                <p className="text-gray-600">support@ccscale.com</p>
                <p className="text-sm text-gray-500 mt-2">
            ...
            <Card className="text-center border-none">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-blue-50 rounded-full flex items-center justify-center mx-auto mb-4">
                  <HelpCircle className="h-8 w-8 text-[#0A1628]" />
                </div>
                <h3 className="font-semibold text-xl mb-2 text-[#0A1628]">
                  {locale === 'en' ? 'FAQ' : '常见问题'}
                </h3>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-[#0A1628] flex items-center">
            ...
            {filteredDownloads.length === 0 ? (
              ...
              filteredDownloads.map((item) => {
                ...
                const getIcon = () => {
                  ...
                  if (item.fileType === 'MP4') return <MonitorPlay className="h-6 w-6 text-blue-500" />;
                    ...
                    <CardContent className="p-5">
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-medium text-[#0A1628] mb-1 truncate">{title}</h4>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center text-[#0A1628]">
            ...
            {faqs.map((faq, index) => {
              ...
              return (
                <div key={index} className="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
                  ...
                  >
                    <span className="font-medium text-[#0A1628]">{question}</span>
                    <ChevronRight
